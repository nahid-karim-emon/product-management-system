...
<div class="container mt-5">
    <h2 class="text-primary mb-4 text-center font-bold">Add Product</h2>
    <div class="row">
                ...
                <div class="card-body">
                    <form id="productForm" action="{{ route('products.store') }}" method="POST">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="number" class="form-control" id="price" name="price" placeholder="Enter product price" step="0.01" required min="0">
                        </div>
